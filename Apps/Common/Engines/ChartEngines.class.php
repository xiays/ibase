 ...
 */
class ChartEngines extends Controller{
    ...
    private $_template = '_Engines/chart'; //模版
        ...
        foreach($this->_table_data_list as &$data){
            ...
            if($this->_right_button_list){
                foreach($this->_right_button_list as $right_button){
                    ...
                    $right_button['href'] = preg_replace('/__data_projectid__/i', $data['project_id'], $right_button['href']);
                    //编译按钮属性
            ...
            if($this->_alter_data_list){
                foreach($this->_alter_data_list as $alter){
                    if($data[$alter['condition']['key']] === $alter['condition']['value']){                    	
                    	$alter['alter_data']['right_button'] = preg_replace('/__data_id__/i', $data[$this->_table_data_list_key], $alter['alter_data']['right_button']);
